					...
					<div className="space-y-2">
						...
						<div className="text-gray-500 text-sm pt-8 space-y-4">
							<p>
								...
								cribados, tanto los diagnosticados de desnutrición en la visita
								basal como los que no presentaron riesgo de desnutrición en
								visita basal.
							</p>

							<p className="italic">
								En aquellos pacientes que en visita basal no presentaran riesgo
								o presencia de desnutrición, se plantea realizar llamada de
								seguimiento realizado cribado en remoto con herramienta R-MAPP
								(acceso a través de
								<a
								...
								proyecto. Si sale en riesgo, se activarán las líneas habituales
								de valoración de cada centro (directamente citar en consultas,
								remitir desde atención primaria, etc.)
							</p>
						</div>
					</div>
