...
export const useInitializeForm = () => {
	...
	const initializeForm = (data: any) => {
		...
		const { visits: visit, patient } = data
		...
		if (dataInitial) {
			setInitial({
				...
				visit_type: dataInitial.visit_type,
				...
				test_chair_five_repetitions:
					dataInitial.test_chair_five_repetitions ?? '',
				...
				bi__standarized_phase_angle:
					dataInitial.bi__standarized_phase_angle ?? '',
			...
			setInitial({ ...initialEmptyData, patient_id: patient.id })
		}
		...
		if (dataVisit1) {
			setVisit1({
				...
				test_chair_five_repetitions:
					dataVisit1.test_chair_five_repetitions ?? '',
				...
				bi__standarized_phase_angle:
					dataVisit1.bi__standarized_phase_angle ?? '',
			...
			setVisit1({ ...visit1EmptyData, patient_id: patient.id })
		}
	}
