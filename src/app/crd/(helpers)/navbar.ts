export const initial = [
	...
	{ toId: 'YXA2C3', label: '¿Tiene el paciente sarcopenia?' },
	...
	{ toId: 'I9J0K1', label: 'Tipo de tratamiento nutricionalindicado' },
	{
		toId: 'N8O9P0',
		label:
			'Refiere al Servicio de Endocrinología y Nutrición para iniciar el tratamiento nutricional',
	},
...
export const visit1 = [
	...
	{
		toId: 'H2I3J4',
		label: '¿El paciente ha seguido la recomendación nutricional prescrita?',
	},
	{
		toId: 'S7T8U9',
		label:
	...
	},
	{
		toId: 'X6Y7Z8',
		label:
			'¿Tras la entravista con el paciente, considera usted que el paciente percibe algún tipo de mejoría asociado al tratamiento nutricional indicado?',
	},
	{
		toId: 'E9F0G1',
		label:
			'¿El paciente ha seguido la recomendación de actividad físiaca prescrita?',
	},
]
